...
bool ChatBotApp::OnInit()
{
    ...
    ChatBotFrame *chatBotFrame = new ChatBotFrame(wxT("My ChatBot"));
...
ChatBotFrame::ChatBotFrame(const wxString &title) : wxFrame(NULL, wxID_ANY, title, wxDefaultPosition, wxSize(width, height))
{
    ...
    std::cout << "Called ChatBotFrame Constructor" << std::endl;
...
{
    std::cout << "Called ChatBotPanelDialog Constructor" << std::endl;
...
{
    std::cout << "Called ChatBotPanelDialog Destructor" << std::endl;
}
